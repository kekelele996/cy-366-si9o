...
var LogTemplates = map[string]string{
	...
	"reservation_waitlist_ok": "reservation waitlist join success, userID=%d, stationID=%d, start=%s, reservationID=%d",
	"reservation_promote_ok":  "reservation waitlist promote success, cancelledID=%d, promotedID=%d, stationID=%d",
