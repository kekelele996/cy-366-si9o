...
const (
	...
	ReservationWaitlisted = "waitlisted" // 候补中
...
var AllReservationStatus = []string{ReservationPending, ReservationWaitlisted, ReservationConfirmed, ReservationCheckedIn, ReservationCompleted, ReservationCancelled}

// IsValidReservationStatus 判断预约状态是否合法。
func IsValidReservationStatus(s string) bool {
	switch s {
	case ReservationPending, ReservationWaitlisted, ReservationConfirmed, ReservationCheckedIn, ReservationCompleted, ReservationCancelled:
		return true
	}
	return false
}
